...
Student::Student(const string& name, unsigned int age, size_t fn, const string& specialty)
	: Person(name, age)
	, m_fN(fn)
...
Student::Student(const Person & person, size_t fn, const string & specialty)
	: Student(person.getName(), person.getAge(), fn, specialty)
{}

void Student::print() const
{
	Person::print();
	cout << " and is studying " << m_specialty << ", FN: " << m_fN << endl;
